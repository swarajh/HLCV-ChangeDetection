# TODO: Maybe we can have a single training script that takes a command line argument to specify which model to train (SimSiam or MIM). This would reduce code duplication and make it easier to maintain.
...
print("Creating SimMIM model...",flush=True)
...
for epoch in range(epochs):
    ...
    for batch_idx, (image_a,image_b,label) in enumerate(train_loader):
    ...
    if avg_loss < best_loss:
        ...
        torch.save(model.state_dict(),"checkpoints/swin_mim.pth")
